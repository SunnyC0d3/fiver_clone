  ...
  const data = [
    ...
    },
    {
      ...
      links: [
        ...
        { name: 'Selling on Fiver', link: '#' },
        { name: 'Buying on Fiver', link: '#' },
      ],
    },
    {
    ...
    {
      headerName: 'Move From Fiver',
      links: [
        { name: 'Fiver Business', link: '#' },
        { name: 'Fiver Pro', link: '#' },
        { name: 'Fiver Logo Maker', link: '#' },
        { name: 'Fiver Guides', link: '#' },
        { name: 'Get Inspired', link: '#' },
        { name: 'Fiver Select', link: '#' },
        { name: 'ClearVoice', link: '#' },
        { name: 'Fiver Workspace', link: '#' },
        { name: 'Learn', link: '#' },
